...
public class JapaneseFlashcardTest implements TestingConstants {
    ...
    public void flashcardFromVerbTest() {
        ...
        JapaneseFlashcard flashcardPolite = new JapaneseFlashcard(verb, verb.conjugate(new JapaneseVerbForm(false, true, presentIdicative)));
        ...
        JapaneseFlashcard flashcardNegative = new JapaneseFlashcard(verb,  verb.conjugate(new JapaneseVerbForm(true, false, presentIdicative)));
